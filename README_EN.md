...
# Mu Sensei · Cognitive Operating System

<p align="center">
  <sub>Distilled by <a href="https://github.com/alchaincyf/nuwa-skill">Nuwa.skill</a></sub>
</p>

> *"Zai bu zai?" (You there?) — the universal conversation starter of a man too busy to type proper greetings*
...
**Distill the cognitive framework of Mu Junsheng (a.k.a. Teacher Mu) — BUPT Associate Professor, drone detection & ISAC engineering expert, 2024 CIC First Prize for Technological Invention, and a man perpetually on a business trip.**

<br>

[Examples](#examples) · [Install](#install) · [What's Distilled](#whats-distilled)
...
```bash
npx skills add your-username/mu-skill
```

Then in Claude Code:

```
> Use Teacher Mu's perspective to analyze how to push this project forward
> What would Teacher Mu think of this research topic
> Switch to Teacher Mu mode, I'm feeling overwhelmed
```
...
**Mu Junsheng** (students call him "Teacher Mu")

| Dimension | Details |
|-----------|---------|
| **Position** | Associate Professor & Doctoral Supervisor, BUPT |
| **Research** | Drone detection & perception, ISAC engineering, integrated sensing and communications |
...
├── LICENSE                         # MIT
├── references/
│   └── research-sources.md         # Complete research sources
├── examples/
...
Distilled using [Nuwa.skill](https://github.com/alchaincyf/nuwa-skill).

Subject: **Mu Junsheng** (Teacher Mu), Associate Professor at BUPT School of Information and Communication Engineering.

Universally described by students as "the mindset GOAT" — never panics, never gets angry, the sky is never actually falling.
